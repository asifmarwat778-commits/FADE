...
## Training Dataset
The complete datasets of experimentally measured kobs values used to train FADE are given in the files `Data2026042605 ONP HOCl.csv` (391 data points) and `Data_NH2Cl.csv` (863 data points). The GUI cod are gievn in the fille attaceh named FADE (First-order AOP Degradation Estimator)
