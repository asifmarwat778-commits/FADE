...
GitHub: https://github.com/asifmarwat778-commits/RatePred
"""
...
GITHUB_URL = "https://github.com/asifmarwat778-commits/RatePred"
...
class DTR_GUI:
    def __init__(self, root):
        self.root = root
        self.root.title("RatePred  \u2014  UV/HOCl/Fe(III) AOP DTR Prediction System")
    ...
    def _build_ui(self):
        ...
        title = tk.Label(header, text="RatePred  \u2014  UV/HOCl/Fe(III) AOP  \u2014  Decision Tree Regressor (DTR) Prediction System",
        ...
        # Status bar
        self.status_var = tk.StringVar(value="Ready. Load data and train DTR model. | RatePred: " + GITHUB_URL)
    ...
    def _build_tab1(self):
        ...
        self.max_feat_var = tk.StringVar(value='auto')
        ttk.Combobox(params_frame, textvariable=self.max_feat_var, values=['auto', 'sqrt', 'log2'], width=8, state='readonly').grid(row=2, column=3, padx=5, pady=2)
    ...
    def _load_data(self, silent=False):
        ...
        try:
            ...
            self.status_var.set(f"Data loaded: {len(self.df)} samples | {len(FEATURES)} features | RatePred")
    ...
    def _train_dtr(self):
        ...
        try:
            ...
            self.status_var.set(f"DTR trained | Test R\u00b2={r2_test:.4f} | RMSE={rmse_test:.6f} | RatePred")
    ...
    def _predict(self):
        ...
        try:
            ...
            self.status_var.set(f"Prediction: k_obs = {pred:.6f} min\u207b\u00b9 | RatePred")
    ...
    def _generate_plot(self):
        ...
        if plot_type == 'Parity Plot (Actual vs Predicted)':
            ...
            self.ax_viz.set_title('DTR Parity Plot  |  RatePred', fontsize=14, fontname='Times New Roman', fontweight='bold')
            ...
            self.ax_viz.set_title('DTR Residual Plot  |  RatePred', fontsize=14, fontname='Times New Roman', fontweight='bold')
            ...
            self.ax_viz.set_title('DTR Actual vs Predicted  |  RatePred', fontsize=14, fontname='Times New Roman', fontweight='bold')
            ...
            self.ax_viz.set_title('DTR Feature Importance  |  RatePred', fontsize=14, fontname='Times New Roman', fontweight='bold')
